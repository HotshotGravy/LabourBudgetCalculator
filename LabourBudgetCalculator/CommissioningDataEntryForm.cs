...
namespace LabourBudgetCalculator
{
    public partial class CommissioningDataEntryForm : Form
    {
        ...
        { /* ... same as corrected_csharp_code_v6 ... */
            var g = new GroupBox { Name = "groupBoxTravel", Text = "Mobilization & Daily Travel", Location = new Point(10, 200), Size = new Size(420, 230) }; tabPage.Controls.Add(g); int y = 25;
            ...
            g.Controls.AddRange(new Control[] { new Label { Text = "Separate Mobilization Days:", Location = new Point(15, 25), AutoSize = true }, cSTT, cSTF, new Label { Text = "Mobilization Travel Method:", Location = new Point(15, 55), AutoSize = true }, cbTM, new Label { Text = "Mobilization Distance (One Way):", Location = new Point(15, 85), AutoSize = true }, nTD, new Label { Text = "miles/km", Location = new Point(300, 85), AutoSize = true }, new Label { Text = "Mobilization Time (One Way):", Location = new Point(15, 115), AutoSize = true }, nTT, new Label { Text = "hours", Location = new Point(300, 115), AutoSize = true }, new Label { Text = "Daily Travel Distance (One Way):", Location = new Point(15, 145), AutoSize = true }, nDTD, new Label { Text = "miles/km", Location = new Point(300, 145), AutoSize = true }, new Label { Text = "Daily Travel Time (One Way):", Location = new Point(15, 175), AutoSize = true }, nDTT, new Label { Text = "hours", Location = new Point(300, 175), AutoSize = true } });
        }
        private void CreateExpensesSection(TabPage tabPage, CommissioningResource resource)
        { /* ... same as corrected_csharp_code_v6 ... */
            var g = new GroupBox { Name = "groupBoxExpenses", Text = "Expenses (Resource Overrides/Specifics)", Location = new Point(10, 440), Size = new Size(420, 220) }; tabPage.Controls.Add(g); int y = 25;
